        ...
        <>
          <div className="mt-8 space-y-3">
            ...
            <div className="flex items-center justify-between text-sm text-zinc-500">
              <span>Preferred channels: <span className="text-zinc-600">Not selected</span></span>
              <Link
                href="/auth?next=/dashboard&intent=publish"
                className="rounded-md bg-[#F97316] px-4 py-2 font-semibold text-black hover:bg-[#ea580c] transition-colors"
              >
          ...
          <div className="mt-8 rounded-lg border border-zinc-800 bg-zinc-950 p-5">
            ...
            <p className="mt-2 text-sm text-zinc-400">
              Create an account to publish posts and connect LinkedIn or other apps.
            </p>
            <div className="mt-4 flex gap-3">
              <Link
                href="/auth?next=/dashboard&intent=publish"
                className="rounded-md bg-[#F97316] px-4 py-2 text-sm font-medium text-black hover:bg-[#ea580c] transition-colors"
              >
                Create account to publish
              </Link>
              <Link
                href="/auth?next=/dashboard&intent=connect"
                className="rounded-md border border-zinc-700 px-4 py-2 text-sm font-medium text-zinc-100 hover:border-zinc-500 transition-colors"
              >
                Connect an app
              </Link>
            </div>
